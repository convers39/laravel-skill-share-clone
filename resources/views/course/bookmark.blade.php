<form class="d-none" id="bookmark-form" method="post" action="{{ route('bookmark.toggle', ['course' => $course]) }}">
  @csrf
</form>
<button form="bookmark-form" class="btn btn-link text-decoration-none" id="save-course">
  @auth
    @if ($course->isSavedBy(auth()->user()))
      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bookmark-check-fill"
        viewBox="0 0 16 16">
