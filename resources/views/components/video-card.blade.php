<li>
  ...
  <div class="row no-gutters border rounded overflow-hidden flex-md-row mb-3 shadow-sm h-md-250 position-relative">
    ...
    <a href="#" class="mt-2 mr-2 text-info" data-toggle="modal" data-target="#video-update-modal"
      data-id="{{ $video->id }}" data-title="{{ $video->title }}" data-track="{{ $video->track }}"
      data-summary="{{ $video->summary }}" data-thumbnail="{{ $video->thumbnail }}">
    ...
    <a href="#" class="mt-2 mr-2 text-danger" data-toggle="modal" data-target="#video-delete-modal"
      data-id="{{ $video->id }}" data-delete=" {{ $video->title }}">
      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash"
        viewBox="0 0 16 16">
        <path
          d="M5.5 5.5A.5.5 0 0 1 6 6v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm2.5 0a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm3 .5a.5.5 0 0 0-1 0v6a.5.5 0 0 0 1 0V6z" />
